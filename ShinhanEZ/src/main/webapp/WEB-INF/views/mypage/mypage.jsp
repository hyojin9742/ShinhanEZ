    ...
    <div id="page">
        ...
        <main id="main">
            <div class="mypage-container">
	            ...
	            <!-- 계약 현황 -->
				<div class="summary-cards contractSummary">
					<div class="summary-card pending">
						<div class="label">대기</div>
						<div class="value">${pendingContract}건</div>
					</div>
					<div class="summary-card overdue">
						<div class="label">만료</div>
						<div class="value">${expiredContract }건</div>
					</div>
					<div class="summary-card pending">
						<div class="label">해지</div>
						<div class="value">${cancelledContract }건</div>
					</div>
					<div class="summary-card paid">
						<div class="label">활성</div>
						<div class="value">${activeContract }건</div>
					</div>
               </div>
				<!-- 계약 목록 -->
				<div class="payment-list">
					<div class="payment-list-header">
						<i class="bi bi-credit-card"></i> 계약 목록
					</div>
					<table class="payment-table">
						<thead>
							<tr>
...
<script src="${ctx}/js/user_contract_mypage.js"></script>
